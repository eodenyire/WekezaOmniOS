...
register_hyphenated_module("ai_scheduler", "ai-scheduler")
register_hyphenated_module("global_fabric", "global-fabric")
register_hyphenated_module("cloud_adapters", "cloud")
register_hyphenated_module("monitoring", "monitoring")
register_hyphenated_module("ui_controls", "ui-controls")
