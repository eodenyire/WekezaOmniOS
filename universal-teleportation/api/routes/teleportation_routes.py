...
restore_manager_module = load_module(
    "restore_manager", os.path.join(PROJECT_DIR, "state-reconstruction", "restore_manager.py")
)
from ..controllers.node_controller import NodeController
from ..controllers.teleport_controller import TeleportController
...
def teleport_console():
    ...
    console_path = os.path.join(API_DIR, "ui", "console.html")
    try:
