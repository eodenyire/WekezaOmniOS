...
node_manager_module = _load_module("node_manager", os.path.join(PROJECT_DIR, "cluster", "node_manager.py"))
NodeManager = node_manager_module.NodeManager


class NodeController:
	def __init__(self):
		self.manager = NodeManager(registry_path=os.path.join(PROJECT_DIR, "cluster", "node_registry.json"))
